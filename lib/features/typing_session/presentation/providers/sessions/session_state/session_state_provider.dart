...
class SessionStateNotifier extends _$SessionStateNotifier {
    ...
    void start({required String target}) {
        ...
        ref.read(metricsNotifierProvider.notifier).setElapsed(Duration.zero);
        ...
        _timer = Timer.periodic(const Duration(seconds: 1), (_) {
            ...
            ref.read(metricsNotifierProvider.notifier).setElapsed(nextElapsed);
        });
    }
    ...
    void stop() {
        ...
        ref.read(metricsNotifierProvider.notifier).setElapsed(state.elapsed);
    }
