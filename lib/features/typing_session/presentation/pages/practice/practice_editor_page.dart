...
import 'package:kothai_app/core/theme/app_typography.dart';
...
class _PracticeEditorPageState extends ConsumerState<PracticeEditorPage> {
    ...
    void initState() {
        ...
        // HANDLE USER INPUT COMBINING WITH CONTROLLER
    ...
    Widget build(BuildContext ctx) {        
        ...
        final progress = (userInput.length / paragraph.length).clamp(0.0, 1.0);
                                ...
                                children: [
                                    ...
                                    AnimatedSlide(
                                        ...
                                        child: SizedBox(
                                            width: double.infinity,
                                            height: double.infinity,
                                            child: PracticeStartButton() // 👈 PRACTICE BOTTOM START BUTTON
                                        )
                                    )
                                ]
                            )
