...
class _SessionStopPageState extends ConsumerState<SessionStopPage> {
  ...
  Widget build(BuildContext context) {
    ...
    void handleSessionStop() {
      ...
      final route = (args is Map && args.containsKey('route'))
          ? args['route'] as String
          : (args is String ? args : Get.currentRoute);
      final index = (args is Map && args.containsKey('index'))
          ? args['index'] as int?
          : null;

      Get.back(result: {'confirmed': true, 'route': route, 'index': index});
    }
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          "Congratulations on reaching ${(typingProgress * 100).toStringAsFixed(0)}%! If you choose to stop now, your progress won't be saved in your statistics.",
                                          style: Theme.of(context)
                                              .textTheme
                                              .bodyMedium
                                              ?.copyWith(
