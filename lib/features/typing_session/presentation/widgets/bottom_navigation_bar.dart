...
class BottomNavigationBarWidget extends ConsumerWidget {
    ...
    Widget build(BuildContext context, ref) {
        ...
        final streakProvider = ref.read(streakModeProvider.notifier);
        ...
        return BottomNavigationBar(
            ...
            onTap: (index) async {
                ...
                if (sessionStatus && isChangingTab) {
                    final result = await Get.to(
                        ...
                        arguments: {'route': intendedRoute, 'index': index},
            ...
            items: [
                ...
                BottomNavigationBarItem(
                    icon: FaIcon(FontAwesomeIcons.trophy, size: KxScale(context).sp(17)),
                    label: 'Challenge'
                ),
                BottomNavigationBarItem(
                    icon: FaIcon(
                ...
                BottomNavigationBarItem(
                    icon: FaIcon(FontAwesomeIcons.grip, size: KxScale(context).sp(18)),
                    label: 'more'
                )
            ]
        );
