...
mixin _$TypingSession {
 ...
 String get sessionId; SessionMode get mode; Difficulty get difficulty; DateTime get startedAt; DateTime get endedAt; Metrics get metrics;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,sessionId,mode,difficulty,startedAt,endedAt,metrics);

@override
String toString() {
  return 'TypingSession(sessionId: $sessionId, mode: $mode, difficulty: $difficulty, startedAt: $startedAt, endedAt: $endedAt, metrics: $metrics)';
}
...
@useResult
$Res call({
 String sessionId, SessionMode mode, Difficulty difficulty, DateTime startedAt, DateTime endedAt, Metrics metrics
});


$DifficultyCopyWith<$Res> get difficulty;$MetricsCopyWith<$Res> get metrics;
...
/// Create a copy of TypingSession
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? sessionId = null,Object? mode = null,Object? difficulty = null,Object? startedAt = null,Object? endedAt = null,Object? metrics = null,}) {
...
as Difficulty,startedAt: null == startedAt ? _self.startedAt : startedAt // ignore: cast_nullable_to_non_nullable
...
$DifficultyCopyWith<$Res> get difficulty {
  ...
  return $DifficultyCopyWith<$Res>(_self.difficulty, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String sessionId,  SessionMode mode,  Difficulty difficulty,  DateTime startedAt,  DateTime endedAt,  Metrics metrics)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TypingSession() when $default != null:
return $default(_that.sessionId,_that.mode,_that.difficulty,_that.startedAt,_that.endedAt,_that.metrics);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String sessionId,  SessionMode mode,  Difficulty difficulty,  DateTime startedAt,  DateTime endedAt,  Metrics metrics)  $default,) {final _that = this;
switch (_that) {
case _TypingSession():
return $default(_that.sessionId,_that.mode,_that.difficulty,_that.startedAt,_that.endedAt,_that.metrics);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String sessionId,  SessionMode mode,  Difficulty difficulty,  DateTime startedAt,  DateTime endedAt,  Metrics metrics)?  $default,) {final _that = this;
switch (_that) {
case _TypingSession() when $default != null:
return $default(_that.sessionId,_that.mode,_that.difficulty,_that.startedAt,_that.endedAt,_that.metrics);case _:
  return null;
...
class _TypingSession implements TypingSession {
  const _TypingSession({required this.sessionId, required this.mode, required this.difficulty, required this.startedAt, required this.endedAt, required this.metrics});
...
@override $DifficultyCopyWith<$Res> get difficulty;@override $MetricsCopyWith<$Res> get metrics;
...
/// Create a copy of TypingSession
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? sessionId = null,Object? mode = null,Object? difficulty = null,Object? startedAt = null,Object? endedAt = null,Object? metrics = null,}) {
