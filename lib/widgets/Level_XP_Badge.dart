...
class LevelXP_Badge extends StatefulWidget {
    const LevelXP_Badge({super.key});

    @override
    State<LevelXP_Badge> createState() => _LevelXP_BadgeState();
}

class _LevelXP_BadgeState extends State<LevelXP_Badge> {
    @override
